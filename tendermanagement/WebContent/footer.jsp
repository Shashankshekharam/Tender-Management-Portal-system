...
<html lang="en">
  <head>
    ...
    <title>Tender Management Project</title>
...
<div class="footer">    
  <div class="navbar navbar-inverse" style="border-radius: 0px ;margin-bottom:0px">
          <div class="container-fluid ">
              ...
              <br>
              <!-- Developer 1 Mr. Shashank Jha-->
                <div class="col-md-3 col-xs-12 col-sm-3" >
                  <div class="col-md-5 col-xs-5 col-sm-5">
                    <img src="images/ShashankJha.jpg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="Shashank Jha Site Developer" title="Shashank Jha"/>
                  </div>
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:red">Mr. Shashank Jha</span>
