...
<html lang="en">
  <head>
    ...
    <title>Tender Management Portal System</title>
        ...
        <div class="container" >
            <div class="navbar-header"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/NIT.png" alt="HIT Haldia" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Tender Management Portal System</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p>NIT KKR Project</p></a>
            </div>
